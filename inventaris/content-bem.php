                                            ...
                                            <td width="540">
                                                <table class="full" align="left" width="540" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <h3>Permintaan Penyewaan <?php echo $type; ?> dari <?php echo $nama_peminjam; ?>,</h3>                                                         
                                                        </td>
                                                    </tr>
                                                    <!-- END OF HEADING-->
                                                    ...
                                                    <tr>
                                                        <td class="left" align="left" style="padding-top: 0px; margin: 0;  font-size:13px ; color:#7f8c8d; font-family: 'Open Sans', Arial, sans-serif; line-height: 23px;mso-line-height-rule: exactly;">
                                                            <span>
                                                            <p>Berikut adalah informasi mengenai rincian penyewaan:</p><br/>
                                                            <p>
                                                            <table>
                                                            ...
                                                            <tr><td>Nama 
Barang Yang Disewa</td><td>:</td><td><?php echo $nama_barang_pinjam; 
?></td></tr>
                                                            <tr><td>Durasi Penyewaan</td><td>:</td><td><?php echo $durasi_peminjaman_dalam_hari; ?> Hari</td></tr>
                                                            ...
                                                            <tr><td>Biaya</td><td>: Rp</td><td><?php echo $biaya; ?></td></tr>
                                                            </table>
                                                            </p><br/>
                                                            <p>Harap segera melakukan konfirmasi ke:<br/>
                                                            1. Indira Mahayani (083891077260).<br/>
                                                            </p>
                                                            Konfirmasi diperlukan untuk mengetahui ketersediaan barang yang di sewa pada hari tersebut. Silahkan tindak lanjuti permintaan peminjaman ini setelah yang bersangkutan melakukan konfirmasi.
                                                            </p>
                                                            <?php
                                                            if($type == 'Eksternal'){
                                                            ?>
                                                            *Salinan invoice yang dikirim ke peminjam juga ada pada lampiran email ini.
                                                            <?php
                                                            }
                                                            ?>
                                                            </span>
