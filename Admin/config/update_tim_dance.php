...
if(isset($_POST['update']))
{
  ...
  $result = mysqli_query($conn, "UPDATE kompetisi SET nama_tim='$nama_tim', instansi='$instansi', nama_k='$nama_k', npm_k='$npm_k', email_k='$email_k', nohp_k='$nohp_k', idline_k='$idline_k' WHERE id='$id'");
        ...
        <div class="col-md-6 col-12 m-5 p-5">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">UPDATE TIM</h4>
              <p class="card-category">ID TIM : <?php echo $id; ?></p>
            </div>
            <div class="card-body">
              <form method="post" action="update_tim_dance.php" enctype="multipart/form-data">
                <div class="row my-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="hidden" name="id" value="<?php echo $id; ?>">
                      <input type="hidden" name="lomba" value="<?php echo $lomba; ?>">
                      <label class="bmd-label-floating">Nama Tim</label>
                      <input type="text" class="form-control" name="nama_tim" value="<?php echo $nama_tim; ?>" required>
                    </div>
                  </div>
                </div>
                <div class="row my-3">
                ...
                <button type="submit" name="update" class="btn btn-primary pull-right">Update Tim</button>
