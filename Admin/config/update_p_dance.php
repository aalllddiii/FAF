      ...
      <div class="row justify-content-center">
        <div class="col-md-6 col-12 m-5 p-5">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="update_p_dance.php" enctype="multipart/form-data">
                <div class="row my-3">
                  <div class="col-md-12">
                ...
                <div class="row my-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">Email a</label>
                ...
                <div class="row my-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">No.Handphone a</label>
                ...
                <div class="row my-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">ID Line a</label>
