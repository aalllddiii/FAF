...
$dance = mysqli_query($conn, "SELECT * FROM kompetisi RIGHT JOIN anggota_tim ON kompetisi.id = anggota_tim.id_tim WHERE kompetisi.lomba='Dance Cover' AND kompetisi.stat_tim=0");
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td>
											<a class="btn btn-warning p-2" href="../config/update_p_dance.php?id_a=<?php echo $row['id_a'];?>"><i class="material-icons">edit</i> Update</a>
										</td>
										<td>
											<a class="btn btn-danger p-2" href="../config/del_a_dance.php?id_a=<?php echo $row['id_a'];?>"><i class="material-icons">delete_forever</i></a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
