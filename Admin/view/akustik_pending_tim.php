...
$akustik = mysqli_query($conn, "SELECT * FROM kompetisi WHERE lomba='Acoustic' AND stat_tim=0");
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Data Pending Tim Acoustic</h5>
				</div>
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover dataTables-example text-center" style="font-size:14px">
							...
							<tbody>
								<?php 
									$no = 0; 
									while ($row = mysqli_fetch_array($akustik)) {
										$no++;
										$id = $row['id'];
								?>
									<tr>
										...
										<td>
											<a class="btn btn-warning p-2" href="../config/update_tim_ak.php?id=<?php echo $row['id'];?>"><i class="material-icons">edit</i> Update</a>
											<a class="btn btn-info p-2" href="../config/acc_tim_ak.php?id=<?php echo $row['id'];?>" ><i class="material-icons">done</i> Approve</a>
										</td>
										<td>
											<a class="btn btn-danger p-2" href="../config/del_tim_ak.php?id=<?php echo $row['id'];?>"><i class="material-icons">delete_forever</i></a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
