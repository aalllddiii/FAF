...
$comic = mysqli_query($conn, "SELECT * FROM kompetisi WHERE lomba='Comic Strip' AND stat_tim=0");
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Data Pending Peserta Comic Strip</h5>
				</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td>
											<a class="btn btn-warning p-2" href="../config/update_comic.php?id=<?php echo $row['id'];?>"><i class="material-icons">edit</i></a>
											
										</td>
										<td>
											<a class="btn btn-info p-2" href="../config/acc_comic.php?id=<?php echo $row['id'];?>" ><i class="material-icons">done</i></a>
										</td>
										<td>
											<a class="btn btn-danger p-2" href="../config/del_comic.php?id=<?php echo $row['id'];?>"><i class="material-icons">delete_forever</i></a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
