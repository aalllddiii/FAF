...
$akustik = mysqli_query($conn, "SELECT * FROM kompetisi RIGHT JOIN anggota_tim ON kompetisi.id = anggota_tim.id_tim WHERE kompetisi.lomba='Acoustic' AND kompetisi.stat_tim=1");
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Data Valid Peserta Acoustic</h5>
				</div>
